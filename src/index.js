class DOMStructor {
    ...
    imageIndex = [];
    imageKeyIndex = [];
    blockRegex = /^(address|figure|article|footer|blockquote|aside|output|body|header|hgroup|main|center|nav|section|dir|div|dl|fieldset|form|img|h[1-6]|hr|br|isindex|menu|noframes|noscript|ol|p|pre|table|ul|dd|dt|frameset|li|tbody|td|tfoot|th|thead|tr|html)$/i;
